...
//  ===========================================================================
void
CCheckBoxEx::SetCheck(BOOL bCheck, BOOL bRepaint)
{
    m_bCheck = bCheck;
...
//  ===========================================================================
DWORD
CCheckBoxEx::SetIcon(int nIconOn, int nIconOff)
{
    HICON       hIconOn         = NULL;
    HICON       hIconOff        = NULL;
...
//  ===========================================================================
DWORD
CCheckBoxEx::SetIcon(LPCTSTR lpszFileNameIn, LPCTSTR lpszFileNameOut)
{
    HICON hIconOn   = NULL;
    HICON hIconOff  = NULL;
...
//  ===========================================================================
DWORD
CCheckBoxEx::SetIcon(HICON hIconOn, HICON hIconOff)
{
    BOOL      bRetValue;
    ICONINFO  ii;
...
//  ...........................................................................
LRESULT
CCheckBoxEx::OnMouseLeave(WPARAM wParam, LPARAM lParam)
{
    CancelHover();
    return 0;
}
...
//  ...........................................................................
LRESULT
CCheckBoxEx::OnSetCheck(WPARAM wParam, LPARAM lParam)
{
    switch (wParam)
    {
    case BST_CHECKED:
...
//  ...........................................................................
LRESULT
CCheckBoxEx::OnGetCheck(WPARAM wParam, LPARAM lParam)
{
	return GetCheck();
}
...
//  ...........................................................................
void
CCheckBoxEx::DrawItem(LPDRAWITEMSTRUCT lpDIS)
{
...
BOOL
CCheckBoxEx::SetLedSize(int nSize)
{
    if (nSize < 0)
        return FALSE;
    else
...
BOOL
CCheckBoxEx::SetLedColor(COLORREF colLedOn, COLORREF colLedOff)
{
    m_colLedOn  = colLedOn;
...
void
CCheckBoxEx::SetToolTip(LPCTSTR lpszText)
{
    if (!lpszText)
        return;
...
void CCheckBoxEx::FreeResources()
{
    if (m_hIconOn.hIcon)

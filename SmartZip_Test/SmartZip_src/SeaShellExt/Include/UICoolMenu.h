...
#ifndef __UICOOLMENU_H__
#define __UICOOLMENU_H__

#include "UISubClass.h"

//////////////////
// CUICoolMenuManager implements "cool" menus with buttons in them. To use:
//
...
class CTRL_EXT_CLASS CUICoolMenuManager : public CSubclassWnd 
{
public:
    DECLARE_DYNAMIC(CUICoolMenuManager)
    CUICoolMenuManager();
    ~CUICoolMenuManager();
...
extern CUICoolMenuManager g_CoolMenuManager;

//////////////////
// Friendly version of MENUITEMINFO initializes itself
//
struct CMyMenuItemInfo : public MENUITEMINFO {
    CMyMenuItemInfo()

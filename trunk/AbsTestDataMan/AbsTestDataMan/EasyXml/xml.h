...
// v.0x160
// revision 19 - 06 - 2010
#define XML_VERSION 0x160
#define XML_VERSION_REVISION_DATE "19-06-2010"
...
#ifdef _WIN32
				lstrcpyA(bs,x);
				MultiByteToWideChar(CP_UTF8,0,x,-1,ws,si);
#endif
				}
			}
...
#ifdef _WIN32
				lstrcpyW(ws,x);
				WideCharToMultiByte(CP_UTF8,0,x,-1,bs,si,0,0);
#endif
				}
			}
		wchar_t* wc()
